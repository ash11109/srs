            ...
            <div className="container px-4 mx-auto">
                ...
                <div className="grid grid-cols-1 gap-9 md:grid-cols-2 lg:grid-cols-3 justify-items-center items-center">
                    {servicesList.map((service, index) => (
                        <div
                            key={index}
                            className={`group relative shadow w-full md:max-w-sm lg:max-w-md bg-gray-50 rounded-2xl p-6 transition-all duration-500 min-h-64 cursor-pointer`}
                            style={{ boxShadow: `0px 10px 100px ${service.colorTheme}50` }}
                            onMouseEnter={(e) => {
                        ...
                        >
                            <div className="flex justify-between items-center mb-4">
                                <div className="bg-white rounded-full flex justify-center items-center  w-14 h-14">
                                    <span
                                        className="text-4xl group-hover:scale-125 transition-all duration-700 animate-spin"
                                ...
                                <div>
                                    <p className="text-8xl font-bold text-[#3f65b713] group-hover:scale-75 transition-all duration-500">
                                        {service.serial}
                                    </p>
                                </div>
                            </div>

                            <h4 className="text-xl font-semibold text-[#233e79] mb-3 capitalize transition-all duration-500 group-hover:text-white tracking-wider">
                                {service.name}
                            </h4>
