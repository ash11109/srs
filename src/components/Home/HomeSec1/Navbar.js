                ...
                <Container className='navinner p-0'>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav" >
                        <Nav defaultActiveKey={activePage}
                            ...
                            <Nav.Link className='navItem mx-3' href="/gallery">Portfolio</Nav.Link>
                            <Nav.Link className='navItem mx-3' href="/blogs">Blog</Nav.Link>
                            <Nav.Link className='navItem mx-3' href="/contactus">Contact</Nav.Link>
