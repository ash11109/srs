        ...
        <section className="light py-14 md:py-24 bg-blue-50 flex content-center items-center min-h-screen">
            <div className="container px-4 mx-auto">
                ...
                <div className="grid grid-cols-1 gap-9 lg:grid-cols-2 justify-items-center">
                    <div className="max-w-4xl mx-auto text-center mt-8 border rounded-lg shadow-sm p-8 md:-rotate-3" style={{ boxShadow: `0px 5px 10px #3F65B750` }}>
                    ...
                    <div className="max-w-4xl mx-auto mt-8">
                        ...
                        <ul className="space-y-4">
                            {[
                                ...
                                <li key={index} className="flex items-start space-x-3 shadow-lg border py-2 px-4 rounded-r-full cursor-pointer hover:scale-105 duration-300" >
