        ...
        <section className="Solp">
            <Container>
                ...
                <div className="Sp1">
                    <span>
                        <div className="p-5">
                            <img src={img1} alt="Values Element" />
                            <h5>Software</h5>
                        </div>
                    </span>
                    <span>
                ...
                <div className="Sp1">
                    <span><div className="p-5">
                        <img src={img6} alt="Values Element" />
                        <h5>Medical</h5>
                    </div>
                    </span>
                    <span><div className="p-5">
                        <img src={img7} alt="Values Element" />
                        <h5>Entertainment</h5>
                    </div>
                    </span>
                    <span><div className="p-5">
                        <img src={img8} alt="Values Element" />
                        <h5>AI</h5>
                    </div>
                    </span>
                    <span><div className="p-5">
                        <img src={img9} alt="Values Element" />
                        <h5>Manufacturing</h5>
                    </div>
                    </span>
                    <span><div className="p-5">
                        <img src={img10} alt="Values Element" />
                        <h5>Logistics</h5>
                    </div>
                    </span>
                </div>
